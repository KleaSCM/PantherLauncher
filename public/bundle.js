  ...
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(function () {
    var fetchGames = /*#__PURE__*/function () {
      var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
        var steamGames, blizzardGames;
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
              return electron__WEBPACK_IMPORTED_MODULE_1__.ipcRenderer.invoke('get-steam-games');
            case 2:
              steamGames = _context.sent;
              _context.next = 5;
              return electron__WEBPACK_IMPORTED_MODULE_1__.ipcRenderer.invoke('get-blizzard-games');
            case 5:
              blizzardGames = _context.sent;
              setGames([].concat(_toConsumableArray(steamGames), _toConsumableArray(blizzardGames)));
            case 7:
            case "end":
